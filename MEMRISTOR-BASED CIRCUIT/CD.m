...
for i = 1:length(interval)
    ...
    x3_next = x3_half_next + hl*X3(x2_half_next, x3_half_next, alpha);
    x2_next = x2_half_next + hl*X2(x1_half_next, x2_half_next, x3_next, beta, delta);
    x1_next = x1_half_next + hl*X1(x2_next);
    x1 = x1_next;
    x2 = x2_next;
    x3 = x3_next;
    X1Values(i) = x1;
